...
export function About() {
  return (
    <>
      <Header />
      <article className=" max-w-7xl m-20 mt-0 block relative h-auto w-auto">
        <div className="relative h-auto w-auto mr-2 mb-10 mt-0 ml-2 block">
          <section className="flex flex-reverse justify-around items-center p-7 h-auto mb-7  rounded-3xl bg-green-300">
            <h2 className="text-start block m-0 font-semibold text-2xl">
              Sobre Beer Better
            </h2>
            <img
              src={Oktoberfest}
          ...
          <section className="block">
            <p>
              ...
              <a href="https://reactjs.org/">React.</a>A fonte do código para
              seu projeto pode ser encontrado no{" "}
              <a
